...
parser.add_argument('--method', type=str, default='codeformer_s3')
...
parser.add_argument("--outf", type=str, default='./exp/codeformer_s3/', help='path log files')
...
print('trainable Parameters number is ', sum(param.numel() for param in model.parameters() if param.requires_grad))
...
def main():
    ...
    while iteration<total_iteration:
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            optimizer.zero_grad()
            output, logits, lq_feat = model(images)
            #b,(hw),n-->b,n,(hw)
            ...
            loss=cross_entropy_loss+codebook_loss+mrae_loss
            loss.backward()
            optimizer.step()
            scheduler.step()
            ...
            if iteration % 100 == 0:
                ...
                print('mrae_losses:',mrae_loss.data)
            if iteration % 1000 == 0:
